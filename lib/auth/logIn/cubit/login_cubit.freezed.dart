    ...
    return _then(_value.copyWith(
      ...
      password: password == freezed
          ...
          : password // ignore: cast_nullable_to_non_nullable
              as Password,
      formzStatus: formzStatus == freezed
          ? _value.formzStatus
...
class _$_LogInState implements _LogInState {
  ...
  @override
  String toString() {
    return 'LogInState(email: $email, password: $password, formzStatus: $formzStatus, errorMessage: $errorMessage)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.formzStatus, formzStatus) &&
            const DeepCollectionEquality()
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(formzStatus),
